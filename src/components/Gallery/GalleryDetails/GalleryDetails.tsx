...
import '@/components/Gallery/GalleryDetails/GalleryDetails.sass';
...
import { MenuGallery } from '@/components/Gallery/MenuGallery/MenuGallery';
...
export function GalleryDetails(){
  ...
  return (    
    ...
    <div className="content-gallery" > 
      <h1 id='nuestros-trabajos'>Nuestra Galería </h1>
      <LightGallery
